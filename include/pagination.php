...
class Pagination 
{
	...
	function create_links()
	{
		...
		if ($loopStart != 1){
			$output .= sprintf('<li class="prev"><a href="' . $link . '">&#171;</a></li>', '1');
		} else {
			$output .= '<li class="prev disabled"><a href="#">&#171;</a></li>';
		}
		
		if ($currentPage > 1){
			$output .= sprintf('<li class="prev"><a href="' . $link . '">&#60;</a></li>', $currentPage - 1);
		} else {
			$output .= '<li class="prev disabled"><a href="#">&#60;</a></li>'; 
		}
		...
		if ($loopEnd != $totalPages){
			...
			$output .= '<li class="next disabled"><a href="#">&#187;</a></li>';
		}

		return '<div class="pagination"><ul>' . $output . '</ul><span class="total_page">Page (' . $currentPage . ' of ' . $totalPages . ')</span></div>';
	}
}
