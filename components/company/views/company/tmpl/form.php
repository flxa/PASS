<?php
	...
	if ($data->db->updated==1) {
		...
		$html .= '<div class="alert-message info"><p><strong>To add a Company, please enter the details below and press Save.</strong></p></div>';
	}
	$html .= '<table>';
	$html .= '<thead>';
	$html .= '<tr><th colspan="2" class="tbl-heading"><img src="img/template/icons/cmp.png"> <span>Add Account</span></th></tr>';
	$html .= '</thead>';
	$html .= '<tbody>';
	...
	$html .= '<tr><td><b>Company Fax</b></td><td><input type="telephone" name="Company_Fax" value="'.$row->Company_Fax.'"'; 
	...
	$html .= '<tr><td><b>Market Segment</b></td><td>'; $html .= $this->segment_list($model,$row->Company_MarketSegment); $html .= ' <a href="#" class="btn success icon" data-controls-modal="modal-from-dom" data-backdrop="true" data-keyboard="true">Add New</a></td></tr>';
	$html .= '</tbody>';
	$html .= '<tfoot>';
