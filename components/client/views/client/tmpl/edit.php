<?php
	...
	if (is_array($data->errors)) {
		...
		$html .= '<div class="alert-message notice"><p>The Client has <b>NOT</b> been updated! Please fix the above error to continue.</p></div>';
	}
	if ($data->db->updated==1) {
		$html .= '<div class="alert-message success"><p>The Client has been successfully <strong>Updated</strong></p></div>';
	} else {
		$html .= '<div class="alert-message info"><p><strong>To edit this Client, please change the details below and press Save.</strong></p></div>';
	}
	$html .= '<table>';
	$html .= '<thead>';
	$html .= '<tr><th colspan="2" class="tbl-heading"><img src="img/template/icons/cnt.png"> <span>Edit Client</span></th></tr>';
	$html .= '</thead>';
	$html .= '<tbody>';
	$html .= '<tr><td class="w80">Company</td><td>'; $html .= $this->company_select_list($model,$row->Client_Company_ID); $html .= '</td></tr>';
